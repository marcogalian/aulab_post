...
class RevisorController extends Controller
{
    ...
    public function acceptArticle(Article $article){
        ...
        return redirect(route('revisor.dashboard'))->with('message', 'Ha aceptado el articulo elegido');
    ...
    public function undoArticle(Article $article) {
        ...
        return redirect(route('revisor.dashboard'))->with('message', 'Devuelto articulo para su revisión');
    }
}
